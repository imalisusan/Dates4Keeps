    ...
    <div class="flex items-center justify-center h-screen">
        <form action="/submit" method="post" class="w-full max-w-sm bg-white shadow-md rounded px-8 pt-6 pb-8">
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <input id="name" value="{{ old('name') }}" name="name" class="appearance-none border-2 @error('name') border-red-400 @else border-gray-200 @enderror rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-teal-500" type="text">
                    @error('name')
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <input id="date" value="{{ old('date') }}" name="date" class="appearance-none border-2 @error('date') border-red-400 @else border-gray-200 @enderror rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-teal-500" type="date">
                    @error('date')
                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                    @enderror
                </div>
